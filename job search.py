...
# -*- coding: utf-8 -*-
"""
Created on Tue August 28 11:35:04 2020
@author:vidya sagar
"""
#import 
import urllib
...
def find_jobs_from(website, job_title, location, desired_characs, filename="results.xls",options={'encoding':'utf-8'}):    
    """
...
desired_characs=['title','companies','links','date_listed']
...
load_indeed_jobs_div('data scientist','london')
